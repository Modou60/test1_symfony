 ...
 */
final class Version20211106133850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD resume LONGTEXT DEFAULT NULL, ADD image VARCHAR(255) NOT NULL');
