 ...
 */
final class Version20211106132705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD image VARCHAR(255) DEFAULT NULL, ADD created_at DATE DEFAULT NULL, ADD resume LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP image, DROP created_at, DROP resume');
